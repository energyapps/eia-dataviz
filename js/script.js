...
/* SELECT TARGET DIV */
// div id for chart container
var chartContainer = $( "#export-import-prod" );
...
$( document ).ready( function () {
	...
	// define universal variables for chart elements
	...
	function showInfo( data ) {
		...
		****/
		...
		var contWidth = chartContainer.width(),
			contHeight = chartContainer.height();
		...
		// reset number of ticks for smaller devices
